...
export class SearchComponent {
  ...
  detail(id: string) { console.log(id,"este es el id");this.service.Detail(id)}
    ...
    this.http.get<Producto[]>('https://api.escuelajs.co/api/v1/products')
      .subscribe((data) => {
        ...
        this.route.queryParams.subscribe(params => {
          ...
          const result = data.filter(e => e.productName.toLocaleLowerCase().includes(myString.toLocaleLowerCase()))
